...
RUN wget --no-verbose "https://repo1.maven.org/maven2/org/apache/commons/commons-compress/1.26.0/commons-compress-1.26.0.jar" \  
  ...
  # && mv /opt/gradle-${GRADLE_VERSION}/lib/plugins/commons-compress-1.26.jar /opt/gradle-${GRADLE_VERSION}/lib/plugins/commons-compress-1.21.jar 
