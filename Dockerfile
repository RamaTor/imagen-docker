...
# Descargar e instalar la versión 1.26 de commons-compress
RUN wget --no-verbose "https://repo1.maven.org/maven2/org/apache/commons/commons-compress/1.26/commons-compress-1.26.jar" \
&& mv commons-compress-1.26.jar /opt/gradle-${GRADLE_VERSION}/lib/plugins/commons-compress.jar \
